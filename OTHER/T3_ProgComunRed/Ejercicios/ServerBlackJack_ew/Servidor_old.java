...
public class Servidor_old implements Runnable {

	Socket socket;
	String hashPlayer;

	public Servidor_old(Socket socket) throws SocketException {
...
//					System.out.println("pito2");
				...
				case "fin": // FINALIZA PARTIDA Y CONEXION
					...
					break;
				default:
					System.err.println("ERROR: no se ha introducido un comando conocido, inténtelo de nuevo");
					break;
				}
