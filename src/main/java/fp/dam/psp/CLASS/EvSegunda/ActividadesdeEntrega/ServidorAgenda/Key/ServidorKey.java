...
public class ServidorKey {
    private static final String KS_Ruta = "src\\main\\java\\fp\\dam\\psp\\CLASS\\EvSegunda\\ActividadesdeEntrega\\ServidorAgenda\\Key\\ServisorKey.p12";
    ...
    private static void crearKey() throws Exception {
        ...
        certChain[0] = cert;
        ks.setKeyEntry(CERT_Alias, keyPai.getPrivate(), KS_Contra.toCharArray(), certChain);
